...
class TableHarianController extends BaseController {
    ...
    function __construct()
    {
        ...
        $this->tableKematianModela = new TimbanganKematianModela();
        $this->tableKematianModelb = new TimbanganKematianModelb();
    }
    ...
    public function index() {
        ...
        $data['timbangan_kematian_a_1'] = $this->tableHarianModel->get_all_kematian_a_1();
        $data['timbangan_kematian_a_2'] = $this->tableHarianModel->get_all_kematian_a_2();
        $data['timbangan_kematian_b_1'] = $this->tableHarianModel->get_all_kematian_b_1();
        $data['timbangan_kematian_b_2'] = $this->tableHarianModel->get_all_kematian_b_2();
    ...
    public function timbangan_b_lantai_1_update($id)
 
    {
        $this->timbanganModelb->update($id, [
            'tanggal' => $this->request->getPost('tanggal'),
            'umur' => $this->request->getPost('umur'),
            'waktu' => $this->request->getPost('waktu'),
            'vaksin' => $this->request->getPost('vaksin'),
    ...
    public function kematian_a_lantai_1_update($id)
 
    {
        $this->tableKematianModela->update($id, [
            'tanggal' => $this->request->getPost('tanggal'),
            'waktu' => $this->request->getPost('waktu'),
            'sekat_1' => $this->request->getPost('sekat_1'),
            'sekat_2' => $this->request->getPost('sekat_2'),
    ...
    public function kematian_b_lantai_1_update($id)
 
    {
        $this->tableKematianModelb->update($id, [
            'tanggal' => $this->request->getPost('tanggal'),
            'waktu' => $this->request->getPost('waktu'),
            'sekat_1' => $this->request->getPost('sekat_1'),
            'sekat_2' => $this->request->getPost('sekat_2'),
    ...
    public function kematian_a_lantai_1_delete($id)
    {   

    $this->tableKematianModela->delete($id);

    session()->setFlashdata("message", "Data berhasil dihapus");
    return redirect()->to(base_url('table-harian'));
    }

    public function kematian_b_lantai_1_delete($id)
    {   

    $this->tableKematianModelb->delete($id);
