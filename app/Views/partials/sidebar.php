            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        ...
                        <span data-key="t-components">Panen</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="input-panen" data-key="t-alerts"> - Input Panen</a></li>
                        <li><a href="table-panen" data-key="t-alerts"> - Table Panen</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i data-feather="file-text"></i>
                        <span data-key="t-components">Laporan harian</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="input-timbangan-harian" data-key="t-alerts"> - Input Data Harian</a></li>
                        <li><a href="table-harian" data-key="t-alerts"> - Table Data Harian</a></li>
                    </ul>
                </li>
